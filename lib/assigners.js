...
var assign = function(entity) {
  ...
  switch (entity.name) {
    ...
    case "Woody Johnson":
      ...
      return entity
    break
     case "The court system":
      entity.gender = g[2]
      entity.category = c[0]
      return entity
    break
     case "Comcast executives":
      entity.gender = g[2]
      entity.category = c[10]
      return entity
    break
    ...
    case "Ken Frazier":
      ...
      return entity
    break
    case "Investigations of the Trump Presidency":
      entity.gender = g[2]
      entity.category = c[11]
      return entity
    break
    ...
    case "Merck":
      ...
      return entity
    break
    case "United States Court of Appeals for the Ninth Circuit":
      entity.gender = g[2]
      entity.category = c[0]
      return entity
    break
    case "N.B.C. executives":
      entity.gender = g[2]
      entity.category = c[10]
      return entity
    break
    case "John Podesta":
      ...
      return entity
    break
    case "Allegations of collusion between Russia and members of the Trump campaign":
      entity.gender = g[2]
      entity.category = c[11]
      return entity
    break
    case "Rod Rosenstein":
      ...
      return entity
    break
    case "The refugee crisis in Europe":
      entity.gender = g[2]
      entity.category = c[11]
      return entity
    break
    case "A rally at the Supreme Court":
      entity.gender = g[2]
      entity.category = c[11]
      return entity
    break
    case "States refusing to hand over voter file information":
      entity.gender = g[2]
      entity.category = c[11]
      return entity
    break
    ...
    case "Jeff Sessions":
      ...
      return entity
    break
    case "The Senate Filibuster":
      entity.gender = g[2]
      entity.category = c[11]
      return entity
    break
    case "Senate Republicans":
      entity.gender = g[2]
      entity.category = c[6]
      return entity
    break
    case "Senate Democrats":
      entity.gender = g[2]
      entity.category = c[4]
      return entity
    break
    case "Alterations to President Trump’s Travel Ban":
      entity.gender = g[2]
      entity.category = c[11]
      return entity
    break
     case "Trade deal between the U.S. and Australia":
      entity.gender = g[2]
      entity.category = c[11]
      return entity
    break
